...
import styles from './SpListSpfxWebPart.module.scss';
import * as strings from 'SpListSpfxWebPartStrings';

export interface ISpListSpfxWebPartProps {
  description: string;
}
...
export default class SpListSpfxWebPart extends BaseClientSideWebPart<ISpListSpfxWebPartProps> {
    ...
    this._getListData()
      .then((response) => {
        ...
        <body>
          ...
          &nbsp;
          <a href="https://cgplindia.sharepoint.com/sites/SPFxDemoSite/_layouts/15/listform.aspx?PageType=8&ListId=%7B356E1030-5316-49DE-B6BB-F03D2A054986%7D&RootFolder=%2Fsites%2FSPFxDemoSite%2FLists%2FEmployeeList&Source=https%3A%2F%2Fcgplindia.sharepoint.com%2Fsites%2FSPFxDemoSite%2FLists%2FEmployeeList%2FAllItems.aspx&ContentTypeId=0x01005B66E9621FC7A142996DE6FAA4211F1A" class="btn btn-primary" name="newItem">+New using portal Add</a>
          </br></br>
